...
void H1Demo::standing_demo(H1State &_state_cur, Vector3d &lin_vel_cmd,
  ...
  _traj_integrate(1) = 0;
  _traj_integrate(3) =
      (_state_cur.foot_pos_world(0, 0) + _state_cur.foot_pos_world(0, 1) +
       _state_cur.foot_pos_world(0, 2) + _state_cur.foot_pos_world(0, 3)) /
      4;
  _traj_integrate(4) =
      (_state_cur.foot_pos_world(1, 0) + _state_cur.foot_pos_world(1, 1) +
       _state_cur.foot_pos_world(1, 2) + _state_cur.foot_pos_world(1, 3)) /
      4;
